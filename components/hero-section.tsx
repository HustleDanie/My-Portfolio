  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto z-10 text-center max-w-4xl px-4">
        ...
        >
          I build AI systems that actually ship. From RAG pipelines and multimodal search to LLM agents and n8n automations, I turn models into software people can rely on every day.
        </motion.p>
